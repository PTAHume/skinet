...
export class CheckoutPaymentComponent implements OnInit {
  ...
  cardNumberErrors?: string | null;
  cardExpiryErrors?: string | null;
  cardCvcErrors?: string | null;
  ...
  private confirmPaymentWithStripe = async (basket: Basket | null) => {
  ...
  private createOrder = async (basket: Basket | null) => {
    if (!basket) throw new Error('Basket is null');
